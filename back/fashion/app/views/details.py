...
def Details():
    if not request.is_json:
        ...
        bookmark = models.Bookmark.query.filter_by(asin=asin).all()
        ...
        share = models.Share.query.filter_by(asin=asin).all()
        ...
        datas['image']=address_format.img(asin)
        datas['productUrl']=address_format.product(asin)
